-- 20260415000005_regen_transaction_log.sql
-- 재생성 티켓 사용 및 구매 내역을 credit_transactions에 기록

-- 1. charge_regen: 재생성 사용 시 credit_transactions에 기록 추가
...
BEGIN
  ...
  VALUES (p_user_id, -p_count, 'regen_use', p_project_id);
...
-- 2. add_regen_tickets: 재생성권 구매 시 credit_transactions에 기록 추가
...
BEGIN
  ...
  VALUES (p_user_id, p_delta, 'regen_purchase');
END;
$$ LANGUAGE plpgsql;
